...
class FileStorage(StorageAbs):
    ...
    def __init__(self, file_handler: FileHandler, model_cls: Type[EntryAbs]):
        ...
        self.model_factory = StringToModelFactory(model_cls=self.model_cls, fieldnames=self.model_cls.fields())
    ...
    def update(self, id, new_entry):
        ...
        all_entries = [self.model_factory.from_string(line) for line in all_lines]
        updated_lines = []
